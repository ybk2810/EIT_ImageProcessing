function [ FEV1 ] = FxSpiro_FEV1_Image( Data, DataSet, Breath_index, ROI_L_xcorr, Fs, C )
...
for B_index = 1:size(Breath_index,2)
    ...
    data2 = DataSet.EIT_L(:,DataSet.Breath(Breath_index(B_index)).inhale+Fs.EIT);
...
colorbar;
[FEV1.Image] = FxEIT_Tri2Grid(Data.Element,Data.Node,sigma,256);
