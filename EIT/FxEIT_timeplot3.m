function [ plot_time ] = FxEIT_timeplot3( sigma, DataSet, start, finish )
% [ plot_time ] = FxEIT_timeplot3( sigma, DataSet, start, finish )
% sigma : 이미 한번 만든 sigma를 가지고 시간정보(DataSet.time)를 가지고 plotting
