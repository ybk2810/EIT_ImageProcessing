function [ Drager_ROI_contour_outside ] = FxKHU_ROI_contour_outside( IMG, imgscale, Cmap )
Drager.IMG = IMG;
figure; imagesc(Drager.IMG);
...
hold on; plot(Drager.ROI_IMG(:,2),Drager.ROI_IMG(:,1),'w','LineWidth',1.5);
