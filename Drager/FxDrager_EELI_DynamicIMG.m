function [ Drager_DynamicIMG_EELI ] = FxDrager_EELI_DynamicIMG( Drager_ChangeRef, Data, Drager_Cursor )
Drager.Dynamic_sigma = Drager_ChangeRef.EIT_0_sigma(:,Drager_Cursor.x);
